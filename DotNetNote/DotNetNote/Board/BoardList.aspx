	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<asp:GridView ID="GrvNotes" runat="server" AutoGenerateColumns="false" DataKeyNames="Id"
					...
					<Columns>
						...
						<asp:TemplateField HeaderText="제목" HeaderStyle-Width="350px"
							ItemStyle-HorizontalAlign="Left">
							<ItemTemplate>
								<%# Helpers.BoardLibrary.FuncStep(
									Eval("Step"))%>
