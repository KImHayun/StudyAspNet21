...
namespace DotNetNote.Board
{
    ...
    {
        private string _Id; //현재 게시글번호

        protected void Page_Load(object sender, EventArgs e)
        {
            _Id = Request["Id"]; //Reauest.QueryString["Id"];
            lnkCancel.NavigateUrl = $"BoardView.aspx?Id={_Id}";

            lblId.Text = _Id;

            //TODO버튼
            btnDelete.Attributes["onClick"] = "return ConfirmDelete();"; //onClientClick="return ConfirmDelete();"; 동일한것
