<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CommentControl.ascx.cs" Inherits="DotNetNote.Controls.CommentControl" %>
<%--<h3>댓글 리스트</h3>--%>
    ...
    <ItemTemplate>
        <tr style="border-bottom: 1px dotted silver;">
            ...
            <td style="width: 350px;">
                <%# Helpers.HtmlUtility.Encode(Eval("Opinion").ToString()) %>
            </td>
