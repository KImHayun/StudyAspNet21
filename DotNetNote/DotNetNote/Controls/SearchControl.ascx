<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SearchControl.ascx.cs" Inherits="DotNetNote.Controls.SearchControl" %>
<div style="text-align:right; height:40px;">
    ...
    <asp:Button ID="btnSearch" runat="server" Text="검 색" 
        CssClass="btn btn-secondary" Width="60px" 
